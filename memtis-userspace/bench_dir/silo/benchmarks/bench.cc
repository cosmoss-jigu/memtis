...
bench_runner::run()
{
  ...
  if (1) {//run_mode == RUNMODE_TIME) {
	...
	elapsed_time += 5;
	commits = current_commits - commits;
	const double tmp_thput =(double)commits / 5.0;
